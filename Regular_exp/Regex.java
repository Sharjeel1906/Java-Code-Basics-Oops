...
public class Regex {
    public static void main(String[] args){
        ...
        // "\\d{1,2}-\\d{1,2}-\\d{4}|\\d{1,2}-\\d{1,2}-\\d{2}" for all types of date || u? means “u appears 0 or 1 time”.
        // u* means 0 or more occurrance.
        String whatToSearch = "[a]^";
        String textToSearchIn = "This is a book of a maths publish on 02-09-2025 and 02-9-2025 and 2-9-2025 and 2-9-25  a";
